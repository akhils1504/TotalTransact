*** Settings ***
Documentation       Running DHL AutoPay Workflow in Specified Enviornment
...
Create AutoPay ACH Payment - Checking
    Overwrite Reqest Information
    ...
    Sleep  ${latency_time_default}
    Click Ext Button  \#celleditbutton
    Sleep  ${latency_time_default}
    Select Simple Combobox Value  \#accounts  ${created_payment_account_ach_name}
    Sleep  ${latency_time_default}
    Button Up The Test


Create AutoPay Card Payment
    ${random}=      Word  #Numerify  @@@!!!
    Overwrite Reqest Information
    Click RefPortal Preview Button Link
    Click RefPortal Execute Button Link
    ...
    Click Ext Button  \#celleditbutton
    Sleep  ${latency_time_default}
    Select Simple Combobox Value  \#accounts  ${created_payment_account_card_name}
    Sleep  ${latency_time_default}
    Button Up The Test